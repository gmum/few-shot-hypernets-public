...
def parse_args(script):
    ...
    parser.add_argument(
        ...
        choices=[
            'baseline', 'baseline++', 'DKT', 'protonet', 'matchingnet', 'relationnet', 'relationnet_softmax',
                    'maml', 'maml_approx', 'hyper_maml', "activation_maml"
                ] + list(hypernet_types.keys()),
        help='baseline/baseline++/protonet/matchingnet/relationnet{_softmax}/maml{_approx}/hn_poc/hyper_maml/activation_maml'
