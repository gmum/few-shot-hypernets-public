...
def add_hn_args_to_parser(parser: ArgumentParser) -> ArgumentParser:
    ...
    hn_args.add_argument("--hn_kernel_layers_no", type=int, default=3, help="Depth of the kernel network")
    ...
    hn_args.add_argument("--hn_kernel_out_size", type=int, default=1600, help="Kernel output dim")
    ...
    hn_args.add_argument("--hn_kernel_op", type=str, choices=[
        "cosine",
        "negcosine",
        "scalar",
    ], default="scalar", help="Kernel operation at the end of the kernel network")
