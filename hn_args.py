...
def add_hn_args_to_parser(parser: ArgumentParser) -> ArgumentParser:
    ...
    hn_args.add_argument("--hn_detach_ft_in_hn", action="store_true", default=False, help="Detach FE output before hypernetwork in training")
    hn_args.add_argument("--hn_detach_ft_in_tn", action="store_true", default=False, help="Detach FE output before target network in training")
