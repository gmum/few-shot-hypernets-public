...
CMD="python train.py --dataset cross_char --num_classes 4112 --method hn_poc_sup_sup_kernel --train_n_way 5 --seed 1 --resume --hn_val_epochs 10 --eval_freq 3"
          ...
          do
            ...
            do
              ...
              do
                for LR in 1e-4;
                do
                  SUFFIX="${HN_HIDDEN_SIZE}-${HN_TN_HIDDEN_SIZE}-${HN_TASKSET_SIZE}-${HN_NECK_LEN}-${HN_HEAD_LEN}_${HN_TN_DEPTH}_${LR}-${HN_KERNEL_HIDDEN_DIM}-${HN_KERNEL_LAYERS_NUM}_sup_sup_kernel_with_ft"
