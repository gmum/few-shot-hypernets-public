...
def train(base_loader, val_loader, model, optimization, start_epoch, stop_epoch, params, *,
    ...
    for epoch in range(start_epoch, stop_epoch):
        ...
        if hist_data:
            ...
            fig = plt.figure()
            plt.violinplot(hist_data["mu_weight_v"])
            neptune_run[f"mu_weight @ {epoch} / violinplot"].upload(File.as_image(fig))
            plt.close(fig)
            ...
            fig = plt.figure()
            plt.violinplot(hist_data["mu_bias_v"])
            neptune_run[f"mu_bias @ {epoch} / violinplot"].upload(File.as_image(fig))
            plt.close(fig)
            ...
            fig = plt.figure()
            plt.violinplot(hist_data["sigma_weight_v"])
            neptune_run[f"sigma_weight @ {epoch} / violinplot"].upload(File.as_image(fig))
            plt.close(fig)
            ...
            fig = plt.figure()
            plt.violinplot(hist_data["sigma_bias_v"])
            neptune_run[f"sigma_bias @ {epoch} / violinplot"].upload(File.as_image(fig))
            plt.close(fig)
