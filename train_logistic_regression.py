...
from data.data_generator import LogisticRegressionDataGenerator
from io_utils import parse_args_logistic_regression, get_resume_file
...
params = parse_args_logistic_regression('train_logistic_regression')
