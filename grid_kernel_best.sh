...
do
  ...
  do
    ...
    do
      ...
      do
        for K_TRANSFORMER_FF_DIM in 256 512 1024 2048;
        do
          for DETACH_EPOCH in 100000;
          do
            for HN_HIDDEN_SIZE in 2048;
            do
              for HN_TN_HIDDEN_SIZE in 256 512;
              do
                ...
                do
                  ...
                  do
                    ...
                    do
                      for LR in 1e-4;
                      do
                        SUFFIX="${HN_HIDDEN_SIZE}-${HN_TN_HIDDEN_SIZE}-${HN_TASKSET_SIZE}-${HN_NECK_LEN}-${HN_HEAD_LEN}_${HN_TN_DEPTH}_${LR}_k-transformer_-${K_TRANSFORMER_HEADS_NUM}-${K_TRANSFORMER_LAYERS_NUM}-${K_TRANSFORMER_FF_DIM}_kernel_${HN_KERNEL_LAYERS_NUM}-${HN_KERNEL_HIDDEN_DIM}_long_kernel_best_arch"
